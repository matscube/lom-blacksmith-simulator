...
/**
 * NOTE: forwardRef is used to pass ref to the child component
 */
...
>(function ModalBasic(props, ref) {
  const useModalValue = useModal({
    focusRef: ref,
    isOpenFirstly: props.isOpenFirstly,
  });
  return (
    <ModalEmpty useModal={useModalValue}>
      <div className='flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600'>
        ...
        <button
          ...
          onClick={() => useModalValue.setIsOpen(false)}
        >
          <svg
            className='w-3 h-3'
            aria-hidden='true'
